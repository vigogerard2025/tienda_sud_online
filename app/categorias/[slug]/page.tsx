...
> = {
  ...
  kekes: {
    name: "Kekes",
    icon: "🎂",
    description: "Húmedos, esponjosos y deliciosos. Recetas de siempre.",
  ...
  "a-la-carta": {
    ...
    icon: "🍽️",
    description: "Platos completos llenos de sabor. La experiencia completa.",
...
function ProductCard({ product }: { product: (typeof allProducts)[0] }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
      ...
      <div className="p-5">
        <h3 className="font-display text-xl text-orange-700 mb-1 leading-tight">
          {product.name}
        </h3>
